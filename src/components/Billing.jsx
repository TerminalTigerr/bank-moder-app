    ...
    return (
      <section id='product' 
				...
				<div className='flex-1 flex justify-center items-start flex-col'>
					...
					Experience banking like never before with our user-friendly mobile app, allowing you to manage your accounts, 
					make secure transactions, and stay in control of your finances anytime, anywhere.
					</p>
